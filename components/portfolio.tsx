      ...
      <main id="main" tabIndex={-1}>
        <section className="hero" id="home">
          <div className="hero-copy">
            ...
            <h1>
              CHIRAG S<span className="name-period">.</span>
            </h1>
          ...
          <div className="hero-note">
            <span className="eyebrow">FIG. 01 — EVENT HORIZON</span>
            <span>Where curiosity bends the possible.</span>
          </div>
        ...
        <section className="section capabilities" id="skills">
          <div className="section-heading">
            ...
            <Sparkles className="section-symbol" strokeWidth={0.7} size={48} />
          </div>
